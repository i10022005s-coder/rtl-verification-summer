...
module fifo_tb7;
    ...
    localparam time TIMEOUT = (6 * TRANSACTION_COUNT + 100) * 20ns;
    ...
    fifo_assertions fifo_assert_chk (
        .vif(fifo_bus)
    );
    ...
    initial begin
        ...
        errors = errors + fifo_assert_chk.assertion_errors;
        if (errors == 0) begin
