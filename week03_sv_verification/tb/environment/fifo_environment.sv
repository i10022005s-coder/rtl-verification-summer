package fifo_environment_pkg;
    ...
    class fifo_environment #(
        ...
        function void build();
            ...
            monitor = new(vif, mon2scb, transaction_count);
        ...
        task environment_check();
            ...
            (scoreboard.checks !== transaction_count) ) begin
                $error("Error of environment: generator.generated_count = %0d, driver.driven_count = %0d, monitor.observed_count = %0d, scoreboard.checks = %0d, expected=%0d.", 
                generator.generated_count, driver.driven_count, monitor.observed_count, scoreboard.checks, transaction_count);
                errors++;
            end
        endtask 
